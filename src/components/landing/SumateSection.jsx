  ...
  return (
    <section className="landing-signup" id="inscripcion">
        ...
        <div className="mx-auto mt-9 max-w-md">
          <div className="rounded-2xl border border-[var(--line)] bg-slate-900/50 p-6 shadow-sm backdrop-blur">
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2.5 rounded-[11px] bg-[var(--accent-green)] px-5 py-3.5 text-sm font-bold text-white no-underline transition hover:bg-[var(--dark-green)]"
            >
          ...
          <div className="mt-5 rounded-2xl border border-[var(--line)] bg-slate-900/50 p-6 shadow-sm backdrop-blur">
            ...
            <button
              ...
              style={{ background: 'var(--accent-green)', boxShadow: '0 8px 22px -10px rgba(46, 189, 142, 0.85)' }}
            >
      ...
      <style>{`
        ...
        .landing-signup .landing-eyebrow::before {
          background: var(--accent-green) !important;
        }
        .landing-signup h2 {
          color: var(--primary-bg) !important;
        }
        .landing-signup .stroke-\\[var\\(--azure-deep\\)\\] {
          stroke: var(--accent-green) !important;
        }
        .landing-signup .border-\\[var\\(--line\\)\\] {
          border-color: var(--accent-green) !important;
        }
        .landing-signup .bg-\\[var\\(--teal\\)\\] {
          background: var(--accent-green) !important;
        }
        .landing-signup .hover\\:bg-\\[var\\(--teal-deep\\)\\]:hover {
