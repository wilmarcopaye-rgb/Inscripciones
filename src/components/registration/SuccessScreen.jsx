    ...
    <div className="space-y-6">
      ...
      <div className="border-t border-white/10 pt-6">
        ...
        <a
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl px-6 py-3 font-poppins text-sm font-semibold text-white no-underline transition hover:opacity-90"
          style={{
